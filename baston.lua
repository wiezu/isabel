...
local tab = gui.Tab(ref, "draincore", "draincore")
...
local function autowall(UserCmd)
    if autowallref:GetValue() then
        gui.SetValue("rbot.hitscan.accuracy.zeus.autowall", true)
        gui.SetValue("rbot.hitscan.accuracy.sniper.autowall", true)
        gui.SetValue("rbot.hitscan.accuracy.smg.autowall", true)
        gui.SetValue("rbot.hitscan.accuracy.shotgun.autowall", true)
        gui.SetValue("rbot.hitscan.accuracy.scout.autowall", true)
        gui.SetValue("rbot.hitscan.accuracy.rifle.autowall", true)
        gui.SetValue("rbot.hitscan.accuracy.pistol.autowall", true)
        gui.SetValue("rbot.hitscan.accuracy.lmg.autowall", true)
        gui.SetValue("rbot.hitscan.accuracy.hpistol.autowall", true)
        gui.SetValue("rbot.hitscan.accuracy.asniper.autowall", true)
    else
        gui.SetValue("rbot.hitscan.accuracy.zeus.autowall", false)
        gui.SetValue("rbot.hitscan.accuracy.sniper.autowall", false)
        gui.SetValue("rbot.hitscan.accuracy.smg.autowall", false)
        gui.SetValue("rbot.hitscan.accuracy.shotgun.autowall", false)
        gui.SetValue("rbot.hitscan.accuracy.scout.autowall", false)
        gui.SetValue("rbot.hitscan.accuracy.rifle.autowall", false)
        gui.SetValue("rbot.hitscan.accuracy.pistol.autowall", false)
        gui.SetValue("rbot.hitscan.accuracy.lmg.autowall", false)
        gui.SetValue("rbot.hitscan.accuracy.hpistol.autowall", false)
        gui.SetValue("rbot.hitscan.accuracy.asniper.autowall", false)
    end
end
...
local function indicators()
    ...
    if lp ~= nil then
        ...
        if isWeapon() then
            mindamage = gui.GetValue("rbot.hitscan.accuracy.weapon." .. weapon_list[lp_gwid] .. ".mindamage")
        end
    end
